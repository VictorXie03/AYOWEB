    ...
    return (
        <div className="ChefsPicks-container">
            ...
            <div className="ChefsPicks-cards">
                <ChefsPicksCard img={chowmein} title="Seafood Cantonese Chowmein(Party Tray)" description="Sliced chicken, shrimp, pork, cooked w/ mixed vegetables, served on top of Cantonese egg noodles" />
